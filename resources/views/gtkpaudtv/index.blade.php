        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        <h2 class="text-white pb-2 fw-bold">GTKPAUD TV</h2>
                        <h5 class="text-white op-7 mb-2">Daftar GTKPAUD TV</h5>
                    </div>
                    <div class="ml-md-auto py-2 py-md-0">
                        <a href="#" class="btn btn-secondary btn-round" onclick="tambahHandle()">Add GTKPAUD TV</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    @section('js')
        <script>
            ...
            const editHandle = (id) => {
                ...
                $.get("/gtkpaudtvEdit/" + id, function(data) {
                    $("#id").val(id);
